...
// The log file is generated by server.js (e.g. via store_local.js).
...
if (!args[2]) { // Arg 0 and 1 are 'node' and 'test_log.js'
  throw new Error('Error: You must specifiy the log file path as an argument.');
}

// Read the file contents into a string, show the result
process.stdout.write('\nLoading contents of ' + args[2] + ' into a string...');
var str = fs.readFileSync(args[2], 'utf8');
console.log('done.');
