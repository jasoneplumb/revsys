...
var HmacCrypto = (function (_super) {
    ...
    HmacCrypto.generateKey = function (algorithm, extractable, keyUsages) {
        ...
        return new Promise(function (resolve, reject) {
            native.HmacKey.generate(algorithm.length || _this.getHashSize(algorithm.hash.name), function (err, key) {
                if (err)
                    reject(err);
                else
    ...
    HmacCrypto.wc2ssl = function (alg) {
