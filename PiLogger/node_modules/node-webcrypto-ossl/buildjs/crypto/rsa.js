                    ...
                    native.Key.importJwk(data, key_type_1, function (err, key) {
                        try {
                            if (err)
                                ...
                                var rsa = new key_1.CryptoKey(key, alg, key_type_1 ? "private" : "public", extractable, keyUsages);
                                resolve(rsa);
                            }
                        }
                        catch (e) {
                    ...
                    importFunction(keyData, function (err, key) {
                        try {
                            if (err)
                                ...
                                var rsa = new key_1.CryptoKey(key, alg, format.toLocaleLowerCase() === "spki" ? "public" : "private", extractable, keyUsages);
                                resolve(rsa);
                            }
                        }
                        catch (e) {
